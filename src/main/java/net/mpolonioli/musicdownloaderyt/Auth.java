...
public class Auth {
    ...
    private static final String CLIENT_ID = "thefakevanguard@gmail.com";
    private static final String CLIENT_SECRET = "barrett50cal";
    ...
    public static Credential authorize(List<String> scopes, String credentialDatastore) throws Exception {
        ...
        clientSecrets.set("client_id", CLIENT_ID);
        clientSecrets.set("client_secret", CLIENT_SECRET);
